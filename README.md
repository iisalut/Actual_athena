...
What were the difficulties we faced ?
We initially thought Godot would be easy since it was similar to python, however we often found ourselves frustrated because we both couldnt work on the same file. This definatly did cut down our time but we found a way to work efficiently 

This is a game of self reflection where one can end up learning more about yourself.
